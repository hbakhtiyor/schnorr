...
// }
//
// func (b *Batch) Append(pk [32]byte, m [32]byte, sig [64]byte) {
...
// 		}
//
// 		checkBatchVerify(&Batch{[][32]byte{pk}, [][32]byte{m}, [][64]byte{sig}}, test.result, test.err)
// 	}
//
...
// 			sig := decodeSignature(test.sig, nil)
//
// 			BatchVerify([][32]byte{pk}, [][32]byte{m}, [][64]byte{sig})
// 		}
// 	}
// }
